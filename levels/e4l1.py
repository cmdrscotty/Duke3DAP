...
class E4L1(D3DLevel):
    ...
    keys = ["Blue","Red"]
    location_defs = [
        {"id": 4, "name": "Basement Container Tripbomb 1", "type": "sprite"},
        ...
        {"id": 135, "name": "Upstairs Red Key Card", "type": "sprite"},
        {"id": 136, "name": "Bathroom Blue Key Card", "type": "sprite"},
        {"id": 149, "name": "Basement Container Tripbomb 2", "type": "sprite"},
        {"id": 150, "name": "Basement Container Tripbomb 3", "type": "sprite"},
        {"id": 151, "name": "Upper Canyon Ledge Pipebombs", "type": "sprite"},
        {"id": 152, "mp": True, "name": "MP Upper Canyon Ledge Steroids", "type": "sprite"},
        ...
        {"id": 544, "mp": True, "name": "MP Outside Area Ledge Shotgun", "type": "sprite"},
        {"id": 545, "mp": True, "name": "MP Outside Area Ledge Chaingun", "type": "sprite"},
        ...
        {"id": 116, "name": "Upstairs Computer Secret", "type": "sector"},
        {"id": 221, "name": "Final Doors Secret", "type": "sector"},
        {"id": 232, "name": "Kitchen Freezer Secret", "type": "sector"},
        {"id": 270, "name": "Cave Secret", "type": "sector"},
        {"id": 274, "name": "Bathroom Secret", "type": "sector"},
        {"id": 388, "name": "Barracks Bed Secret", "type": "sector"},
        {"id": 414, "name": "Upper Canyon Ledge Secret", "type": "sector"},
    ...
    def main_region(self) -> Region:
        ...
        ret = self.region(
            ...
            [
                ...
                "Bathroom Blue Key Card",
                "Bathroom Chaingun",
                "Kitchen Freezer Secret",
        ...
        basement_container = self.region(
            "Basement Container",
            [
                "Basement Container Tripbomb 1",
                "Basement Container Tripbomb 2",
                "Basement Container Tripbomb 3",
            ],
        )
        ...
        blue_key_area = self.region(
            "Blue Key Room",
            [
                "Upstairs Red Key Card",
                "Upstairs Computer Secret",
        ...
        self.connect(janitor_closet, mission_impossible, 
                     r.can_jump & (r.explosives | 
                                   (r.can_sprint & r.difficulty("hard"))
                                   ))
