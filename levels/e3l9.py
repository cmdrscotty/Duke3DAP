...
class E3L9(D3DLevel):
    ...
    keys = []
    location_defs = [
        {"id": 1, "density": 5, "name": "MP Floor Armor", "type": "sprite"},
        {"id": 12, "density": 5, "name": "MP Ledge Shotgun", "type": "sprite"},
        ...
        {"id": 18, "density": 5, "name": "MP Floor Chaingun", "type": "sprite"},
        {"id": 19, "density": 5, "name": "MP Floor Freezethrower", "type": "sprite"},
        {"id": 20, "density": 5, "name": "MP Floor RPG", "type": "sprite"},
        {"id": 21, "density": 5, "name": "MP Floor Devastator", "type": "sprite"},
        ...
        {"id": 85, "density": 5, "name": "MP Ledge Jetpack 1", "type": "sprite"},
        {"id": 86, "density": 5, "name": "MP Ledge Jetpack 2", "type": "sprite"},
        {"id": 87, "name": "Floor Night Vision Goggles", "type": "sprite"},
        {"id": 88, "density": 5, "name": "MP Ledge Chaingun", "type": "sprite"},
        {"id": 89, "density": 5, "name": "MP Ledge Pipebombs", "type": "sprite"},
        {"id": 90, "density": 5, "name": "MP Ledge Devastator", "type": "sprite"},
        {"id": 91, "density": 5, "name": "MP Ledge RPG", "type": "sprite"},
        {"id": 92, "density": 5, "name": "MP Ledge Shrinker", "type": "sprite"},
        {"id": 93, "density": 5, "name": "MP Ledge Freezethrower", "type": "sprite"},
